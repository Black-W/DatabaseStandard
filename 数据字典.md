...
| team_main_course_id | bigint unsigned | NO |   | 共享分组，主课程id |
| seminar_main_course_id | bigint unsigned | NO |   | 共享讨论课，主课程id |
...
| reprot_url | varchar(50) | YES |   | 提交的报告文件位置 |
...
| presentation_score_method | tinyint unsigned | NO |   | 本轮展示分数计算方法 |
| report_score_method | tinyint unsigned | NO |   | 本轮报告分数计算方法 |
| question_score_method | tinyint unsigned | NO |   | 本轮提问分数计算方法 |
...
| score | bigint unsigned | YES |   | 提问分数 |
...
| seminar_status | varchar(20) | NO |   | 讨论课所处状态 |
...
| --- | --- | --- | --- | --- |
|  id | bigint unsigned | NO | PRI |  |
| min_male | tinyint unsigned | YES |   | 最少男生 |
| max_male | tinyint unsigned | YES |   | 最多男生 |
| min_female | tinyint unsigned | YES |   | 最少女生 |
| max_female | tinyint unsigned | YES |   | 最多女生 |
...
#### seminar_score_table表

| 字段名 | 数据类型（长度） | 允许为空 | 是否主键 | 注释 |
| --- | --- | --- | --- | --- |
| klass_seminar_id | bigint unsigned | NO | PRI | 班级讨论课id  |
| team_id | bigint unsigned | NO | PRI  | 小组id |
| total_score | decimal | YES |   | 总成绩 |
| presentation_score | decimal | YES |   | 展示成绩 |
| question_score | decimal | YES |   | 提问成绩 |
| report_score | decimal | YES |   | 报告成绩 |
